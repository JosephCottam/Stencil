...
(deftest infer-types
  ...
  (is (= (t/infer-types '($ptuple ($meta) (quote ($meta) (x)) x ($meta)))
         '($ptuple ($meta (type fn)) (quote ($meta (type fn)) (x)) x ($meta (type ***)))))
  (is (= (t/infer-types '(let (((x ($meta)) (do ($meta) (f ($meta))))) ($ptuple ($meta) (quote ($meta) (x)) x ($meta))))
         '(let (((x ($meta (type ***))) (do ($meta (type fn)) (f ($meta (type fn)))))) ($ptuple ($meta (type fn)) (quote ($meta (type fn)) (x)) x ($meta (type ***))))))
