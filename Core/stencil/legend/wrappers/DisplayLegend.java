...
public final class DisplayLegend implements StencilLegend {
	protected DisplayLayer layer;
	protected long cachedSize =-1;
	
	public DisplayLegend(DisplayLayer layer) {this.layer = layer;}
	...
	public LegendData getLegendData(String module) {
