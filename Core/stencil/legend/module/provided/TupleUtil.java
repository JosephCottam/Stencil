...
public class TupleUtil extends BasicModule {
	 ...
	 */
	public static final class EchoCategorize implements StencilLegend {
		...
		public StencilLegend duplicate() throws UnsupportedOperationException {
		...
		protected static LegendData complete(LegendData base, Specializer spec) {
