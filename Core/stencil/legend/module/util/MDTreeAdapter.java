...
class MDTreeAdapter extends CommonTreeAdaptor {
	...
	protected static class FacetData extends MetaTree implements stencil.legend.module.FacetData {
	...
	protected static class OpData extends MetaTree implements stencil.legend.module.LegendData {
	...
	protected static class ModuleData extends MetaTree implements stencil.legend.module.ModuleData {
		...
		public Module getModule() {
			if (module == null) {
				...
				try {c = clss.getConstructor(stencil.legend.module.ModuleData.class);}
