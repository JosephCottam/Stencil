 ...
 * 
 * This represents an EPS document. Several EpsGraphics2D objects may point to the same EpsDocument.<br>
...
public class EpsDocument
{
	...
	// us, as we need to replace the clipping region if another EpsGraphics2D object tries to use us.
