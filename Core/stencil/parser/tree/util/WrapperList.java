...
import stencil.parser.tree.StencilTree.ChildrenIterator;

/**Class to wrap an arbitrary tree in a java.util.List interface.*/ 
public final class WrapperList<T extends StencilTree> implements java.util.List<T> {
	 ...
	 */
	public WrapperList(Tree root) {
		if (root == null) {root = (Tree) ParseStencil.TREE_ADAPTOR.create(StencilParser.NULL, "DUMMY");}
		this.root = root;
	}
