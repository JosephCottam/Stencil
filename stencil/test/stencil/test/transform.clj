  ...
  (is (= (t/ensure-fields 
           '(table x ($meta) 
                   (data (when ($meta) (pred) (gen) 
                           (ptuple ($meta) (fields a ($meta (type int))) 0)))))
           '(table x ($meta) 
                   (fields a ($meta (type int)))
                   (data (when ($meta) (pred) (gen) (ptuple ($meta) (fields a ($meta (type int))) 0))))))
  (is (= (t/ensure-fields 
          '(table x ($meta) 
